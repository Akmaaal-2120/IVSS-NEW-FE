            ...
            <div class="row g-5">
                                ...
                                <li class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <a href="https://<?php echo htmlspecialchars($dosen_detail['linkedin']); ?>"
                                            target="_blank" class="btn btn-primary btn-sm rounded-pill fw-bold"
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-5 p-4 bg-white rounded shadow-sm">
                        <h4 class="fw-bold text-dark mb-3"><i class="bi bi-info-circle-fill me-2 text-warning"></i>
                            Profil Dosen</h4>
                        <div class="row">
                            <div class="col-sm-12">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex align-items-center px-0">
                                        ...
                                        <span class="fw-bold ms-1"
                                            style="color: #14123A;"><?php echo htmlspecialchars($dosen_detail['nip']); ?></span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-center px-0">
                                        <span class="fw-medium text-dark me-3" style="min-width: 120px;">NIDN</span>:
                                        <span class="fw-bold ms-1"
                                            style="color: #14123A;"><?php echo htmlspecialchars($dosen_detail['nidn']); ?></span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-center px-0">
                                        <span class="fw-medium text-dark me-3" style="min-width: 120px;">Jabatan</span>:
                                        <span class="fw-bold ms-1"
                                            style="color: #14123A;"><?php echo htmlspecialchars($dosen_detail['jabatan']); ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="mb-5 p-4 bg-white rounded shadow-sm">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="<?php echo htmlspecialchars($dosen_detail['scopus']); ?>" target="_blank"
                            ...
                            <a href="<?php echo htmlspecialchars($dosen_detail['google_scholar']); ?>" target="_blank"
                                class="btn rounded-pill fw-bold"
                                style="background-color: #14123A; color: #fff; border: none; pointer-events: auto; text-decoration: none; font-size: 0.85rem; padding: 4px 18px;">
                            ...
                            <a href="<?php echo htmlspecialchars($dosen_detail['sinta']); ?>" target="_blank"
                                class="btn rounded-pill fw-bold"
                                style="background-color: #14123A; color: #fff; border: none; pointer-events: auto; text-decoration: none; font-size: 0.85rem; padding: 4px 18px;">
