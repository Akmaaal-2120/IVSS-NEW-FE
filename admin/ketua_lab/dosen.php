...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="mb-3 text-right">
            <a href="tambah_dosen.php" class="btn btn-success btn-sm">
        ...
        if (isset($_GET['msg'])) {
            $m = $_GET['msg'];
            if ($m === 'created') echo '<div class="alert alert-success">Dosen berhasil ditambahkan.</div>';
            if ($m === 'updated') echo '<div class="alert alert-success">Dosen berhasil diubah.</div>';
            if ($m === 'deleted') echo '<div class="alert alert-success">Dosen berhasil dihapus.</div>';
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dosenTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="edit_dosen.php?nip=<?= urlencode($row['nip']); ?>" class="btn btn-primary btn-xs"><i class="fas fa-edit"></i> Edit</a>
                            <a href="hapus_dosen.php?nip=<?= urlencode($row['nip']); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Hapus dosen <?= addslashes(htmlspecialchars($row['nama'])) ?> ?');">
