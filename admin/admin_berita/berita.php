        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <a href="tambah_berita.php" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Tambah Berita</a>
                </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="beritaTable" width="100%" cellspacing="0">
                                <thead class="table-primary text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit_berita.php?id=<?= $b['berita_id'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="hapus_berita.php?id=<?= $b['berita_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin hapus berita ini?')"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
