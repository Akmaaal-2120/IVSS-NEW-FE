...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'], $_POST['riset_id'])) {
    ...
    if ($_POST['action'] === 'delete') {
        // Bisa hapus jika status pending atau approve_dosen_pembimbing (status awal admin lab)
        ...
        if ($del && pg_affected_rows($del) > 0) {
            ...
            $alert = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="fas fa-exclamation-triangle"></i> Gagal menghapus riset. Riset yang sudah disetujui Ketua Lab tidak bisa dihapus.
                <button type="button" class="close" data-dismiss="alert">&times;</button>
            </div>';
        }
    }
...
// Ambil daftar riset saya (admin lab)
...
<head>
    <meta charset="utf-8">
    <title>Riset Saya (Admin Lab)</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <i class="fas fa-list mr-2"></i>Daftar Pengajuan Riset Anda
                            </h6>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_GET['msg'])) {
                                ...
                                if ($msg === 'created') {
                                    ...
                                    <i class="fas fa-check-circle"></i> Riset berhasil diajukan dan menunggu approval Ketua Lab.
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                </div>';
                                } elseif ($msg === 'updated') {
                                    echo '<div class="alert alert-success alert-dismissible fade show">
                                ...
                                <table class="table table-bordered table-hover" id="risetTable" width="100%"
                                    ...
                                    <thead class="thead-light">
                                        <tr class="text-center">
                                            ...
                                            <th width="14%">Tanggal Pengajuan</th>
                                            <th width="14%">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
